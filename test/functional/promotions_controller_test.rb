...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { method: @promotion.method, start_time: @promotion.start_time, title: @promotion.title }
    end
  ...
  test "should update promotion" do
    put :update, id: @promotion, promotion: { method: @promotion.method, start_time: @promotion.start_time, title: @promotion.title }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
